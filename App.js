 ...
 * @MomenKamal
 ...
 APP.JS: The main page of the application consisting of navigation bars:
      ...
      Tab Navigator: navigators between the common views that the user mainly interact with; including teat, history,reports and ChatBot - NOT USED 
*/
...
// Ignore this current application doesn't use thus naviagtion
